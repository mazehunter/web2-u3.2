    ...
    public partial class servicios : System.Web.UI.Page
    {
        ...
        private void RellenarLista()
        {
            try
            {
                ...
                Tabla = NegProductos.ListaServicios();
        ...
        protected void BtnGrabarServicio_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    RellenarLista();
                    BtnNuevoServicio_Click(sender,e);
                    LblMensaje.Text = "Servicio Agregado";
                }
            }
            catch (Exception ex)
            {
        ...
        protected void BtnEliminarProducto_Click(object sender, EventArgs e)
        {
            ...
            if (TxtIdItem.Text == "")
            {
                LblMensaje.Text = "Seleccione Servicio";
                return;
            }
            ...
            try
            {
                ...
                if (filas > 0)
                {
                    RellenarLista();
                    BtnNuevoServicio_Click(sender, e);
                    LblMensaje.Text = "Servicio Eliminado";
                }
            }
            catch (Exception ex)
            {
