<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productos.aspx.cs" Inherits="SistemaWeb.productos" %>
...
<body id="principal">
  ...
  <br />
            ...
            <tr>
                ...
                <td class="style15" colspan="4">
                    <asp:Button ID="BtnNuevoProducto" runat="server" BackColor="Black" 
                        Font-Bold="True" ForeColor="#FFFFCC" onclick="BtnNuevoProducto_Click" 
                        Text="Nuevo Producto" Width="140px" />
                    <asp:Button ID="BtnGrabarProducto" runat="server" BackColor="Black" 
                        Font-Bold="True" ForeColor="#FFFFCC" onclick="BtnGrabarProducto_Click" 
                        Text="Grabar Producto" Width="140px"
                        />
                    <asp:Button ID="BtnEliminarProducto" runat="server" BackColor="Black" 
                        Font-Bold="True" ForeColor="#FFFFCC" onclick="BtnEliminarProducto_Click" 
                        Text="Eliminar Producto" Width="140px" 
                        OnClientClick="javascript:if (!confirm('¿Desea Eliminar Producto?')) return false;"
                        />
                </td>
                <td class="style15">
                    &nbsp;</td>
